...
<head>
    ...
    <!-- 
        - custom css link
    -->
    <link rel="stylesheet" href="../pantallaAdmin/calculadoraFletes/styles.css">
      ...
      <ul class="feature-list grid-list">
        <li>
          <div class="feature-card" style="--card-number: '01'">
            <div class="card-icon">
              <img src="../pantallaAdmin/calculadoraFletes/assets/img/feature-icon-1.png" width="72" height="91" alt="">
            </div>
        ...
        <li>
          <div class="feature-card" style="--card-number: '02'">
            <div class="card-icon">
              <img src="../pantallaAdmin/calculadoraFletes/assets/img/feature-icon-2.png" width="94" height="94" alt="">
            </div>
        ...
        <li>
          <div class="feature-card" style="--card-number: '03'">
            <div class="card-icon">
              <img src="../pantallaAdmin/calculadoraFletes/assets/img/feature-icon-3.png" width="93" height="93" alt="">
            </div>
